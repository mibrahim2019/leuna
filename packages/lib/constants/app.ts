...
export const NEXT_PUBLIC_SOURCE_CODE_URL = () =>
  env('NEXT_PUBLIC_SOURCE_CODE_URL') ?? 'https://github.com/mibrahim2019/leuna';

export const NEXT_PUBLIC_SOURCE_CODE_REVISION = () =>
  env('NEXT_PUBLIC_SOURCE_CODE_REVISION') ?? 'main';

export const NEXT_PUBLIC_SOURCE_CODE_REVISION_URL = () =>
  env('NEXT_PUBLIC_SOURCE_CODE_REVISION_URL');
...
export const SUPPORT_EMAIL = env('NEXT_PUBLIC_SUPPORT_EMAIL') ?? 'support@leuna.app';
