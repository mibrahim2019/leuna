...
This document defines the writing conventions for Sign Leuna documentation.
...
1. **Users** - People using the Sign Leuna web application to send and sign documents
2. **Developers** - Building integrations with the API or SDKs
3. **Self-hosters** - Running their own Sign Leuna instance
