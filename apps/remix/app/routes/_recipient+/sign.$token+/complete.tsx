...
export default function CompletedSigningPage({ loaderData }: Route.ComponentProps) {
  ...
  return (
    <DotPatternPageBackground
      className={cn('signing-area dark-mode-disabled flex flex-col items-center', {
        'pt-0': canSignUp,
      })}
    >
      <div
        className={cn(
          'flex w-full flex-col items-center overflow-hidden px-4 pt-16 md:px-8 lg:pt-20 xl:pt-28',
