---
title: Sign Leuna Documentation
...
<div className="not-prose max-w-4xl mx-auto px-4">
  ...
  <div className="grid gap-4 md:grid-cols-3 mb-12">
    ...
    <a href="/docs/self-hosting" className="group relative flex flex-col rounded-xl border bg-fd-card p-6 transition-all hover:border-fd-primary/50 hover:shadow-md">
      ...
      <p className="text-sm text-fd-muted-foreground mb-4 flex-1">
        Deploy your own Sign Leuna instance with Docker, Kubernetes, or Railway.
      </p>
  ...
  <div className="rounded-xl border bg-gradient-to-r from-fd-primary/5 to-fd-primary/10 p-6 text-center">
    ...
    <p className="text-sm text-fd-muted-foreground mb-4">
      Sign Leuna is open source. Contribute, ask questions, or share feedback.
    </p>
    <div className="flex flex-wrap justify-center gap-3">
      ...
      <a href="https://leuna.app" className="inline-flex items-center gap-2 rounded-lg bg-fd-primary text-fd-primary-foreground px-4 py-2 text-sm font-medium hover:bg-fd-primary/90 transition-colors">
        Try Sign Leuna
      </a>
    </div>
  </div>
