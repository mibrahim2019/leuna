...
Organisation ownership cannot be transferred through the regular organisation settings. Only a Sign Leuna instance administrator can transfer ownership through the admin panel.

If you are using Sign Leuna Cloud, contact support to request an ownership transfer. If you are self-hosting, an instance administrator can follow the steps below.
...
<Steps>
  ...
  <Step>
    Sign in or create a Sign Leuna account.
  </Step>
  <Step>
