---
title: Overview
description: Organisations are the top-level entity in Sign Leuna, containing teams, members, and shared settings.
---
...
Organisations are the top-level entity in Sign Leuna's hierarchy. Each organisation can contain multiple teams, and each team can have multiple members.
...
![Create organisation in Sign Leuna dashboard](/organisations/organisations-create.webp)
