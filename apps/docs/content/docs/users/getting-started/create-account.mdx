...
description: Sign up for Sign Leuna and configure your profile.
---
...
Check your inbox for a verification email and click the confirmation link. The email is sent from `noreply@leuna.app`.
...
<Steps>
  <Step>
    ...
    ![Sign Leuna account security page showing security options](/get-started-images/leuna-account-security-page.webp)
  ...
  <Step>
    ...
    ![Dialog to enable two-factor authentication with QR code setup](/get-started-images/leuna-enable-2-factor-authentication.webp)
  ...
  <Step>
    ...
    ![Passkeys settings page showing registered passkeys](/get-started-images/leuna-passkeys-page.webp)
  ...
  <Step>
    ...
    ![Dialog to add a new passkey with name input field](/get-started-images/leuna-add-passkey-box.webp)
