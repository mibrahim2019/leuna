...
- **Create one automatically**: Sign Leuna creates a new "Direct Link Recipient" for you

![Choose direct link recipient](/direct-links/choose-direct-link-recipient-leuna.webp)
...
```
https://app.leuna.app/d/<unique-token>
```

![Document direct link](/direct-links/document-direct-link-leuna.webp)
...
If the recipient has a Sign Leuna account with the email they entered, the document also appears in their Documents dashboard.
...
You can showcase templates with direct links on your public Sign Leuna profile:
...
![Sign Leuna profile with direct links](/direct-links/leuna-profile.webp)
...
```html
<a href="https://app.leuna.app/d/your-token">Sign our agreement</a>
```
