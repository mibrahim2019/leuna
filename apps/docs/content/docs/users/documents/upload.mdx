...
<Callout type="warn">
  Sign Leuna does not support password-protected or encrypted PDF files. Remove encryption before
  uploading.
</Callout>

## Upload Methods

![Documents dashboard](/document-signing/leuna-documents-dashboard.webp)
...
<Steps>
  <Step>
    ...
    Open your [Documents dashboard](https://app.leuna.app/documents).
...
1. **Processing**: Sign Leuna validates the PDF and extracts page information
