---
title: GDPR
description: Understand how Sign Leuna handles GDPR compliance for data processing and storage.
---
...
When using Sign Leuna for document signing, two distinct data processing roles apply:

| Role                | Description                                                                           |
| ------------------- | ------------------------------------------------------------------------------------- |
| **Data Controller** | You (the organisation using Sign Leuna) determine the purposes and means of processing |
| **Data Processor**  | Sign Leuna processes personal data on your behalf according to your instructions       |
...
As the data processor, Sign Leuna:
...
Sign Leuna processes personal data necessary to provide document signing services:
...
Where your data is stored depends on how you use Sign Leuna:

<Tabs items={['Sign Leuna Cloud', 'Self-Hosted']}>
<Tab value="Sign Leuna Cloud">
...
Contact Sign Leuna for specific information about sub-processors and data centre locations.

</Tab>
<Tab value="Self-Hosted">

When you self-host Sign Leuna:

- You control all data storage locations
- No data is transmitted to Sign Leuna's infrastructure
...
- Export user and document data from your Sign Leuna account
- Delete user accounts and associated documents
- Contact Sign Leuna support for assistance with cloud-hosted data

## Data Deletion

Sign Leuna supports data deletion to help fulfill erasure requests:
...
Self-hosting Sign Leuna can simplify GDPR compliance:
...
- Contact [support@leuna.app](mailto:support@leuna.app) to request a DPA
- The DPA covers Sign Leuna's obligations as a data processor

</Tab>
<Tab value="Self-Hosted">

No DPA with Sign Leuna is required since no personal data is processed by Sign Leuna.
...
This documentation is provided for informational purposes only and does not constitute legal advice. GDPR compliance depends on your specific circumstances, including how you use Sign Leuna, what data you process, and your organisation's obligations.
...
- [Self-Hosting Guide](/docs/self-hosting) - Deploy Sign Leuna on your own infrastructure
