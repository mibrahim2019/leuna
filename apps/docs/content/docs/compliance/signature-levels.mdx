...
<Callout type="info">
  Sign Leuna seals all signed documents cryptographically, regardless of signature level, to prevent
...
## What Sign Leuna Provides

Sign Leuna supports Simple Electronic Signatures (SES) with features that enhance evidentiary value:
