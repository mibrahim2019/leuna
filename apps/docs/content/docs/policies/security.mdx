---
title: Security
description: Security practices for Sign Leuna Cloud and self-hosted deployments, along with our vulnerability disclosure process.
---
...
<Accordions type="multiple">
  <Accordion title="Encryption in Transit">
    All data transmitted to and from Sign Leuna is encrypted using TLS 1.2 or higher. This includes:
  ...
  <Accordion title="Application-Level Encryption">
    Sign Leuna encrypts sensitive data at the application level:
...
Sign Leuna operates a responsible disclosure process for security vulnerabilities.
...
When self-hosting Sign Leuna, you are responsible for the security of your deployment. The following recommendations apply:
...
- **Security vulnerabilities**: security@leuna.app
- **General questions**: support@leuna.app
