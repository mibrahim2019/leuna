...
Join the Sign Leuna Discord server to:

- Ask questions and get help from the community
- Share feedback and feature requests
- Connect with other Sign Leuna users
...
Paid plans include access to direct support from the Sign Leuna team.
...
- Email support at support@leuna.app
- Account and billing assistance
- Technical guidance for Sign Leuna Cloud usage
...
- Private Discord channel for direct communication with the Sign Leuna team
...
- Guidance on Sign Leuna features and functionality
...
For billing disputes or account issues, email support@leuna.app with your account details.
...
Sign Leuna follows responsible disclosure practices. Security researchers who report valid vulnerabilities responsibly will be acknowledged.

## Contact

| Purpose          | Contact                                                        |
| ---------------- | -------------------------------------------------------------- |
| General support  | support@leuna.app                                          |
| Security issues  | security@leuna.app                                         |
| Enterprise sales | [sales@leuna.app](https://documen.so/enterprise)           |
| Privacy requests | privacy@leuna.app                                          |
...
- [Privacy Policy](/docs/policies/privacy) - How Sign Leuna handles your data
