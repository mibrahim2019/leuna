...
description: Commercial license that removes AGPL-3.0 source code disclosure requirements, allowing organisations to integrate Sign Leuna into proprietary products.
---
...
- **Build proprietary products**: Integrate Sign Leuna into commercial software without releasing source code
...
- **Need to keep modifications private**: Any changes to Sign Leuna source code that you don't want to disclose

<Callout type="info">
  If you run Sign Leuna without modifications, or your modifications are open source under AGPL-3.0,
...
| SaaS product using Sign Leuna API only        | Community Edition  |
| SaaS product with modified Sign Leuna code    | Enterprise Edition |
...
<Accordions type="multiple">
  <Accordion title="License Rights">
    ...
    - **Proprietary integration**: Embed Sign Leuna in closed-source products without licensing conflicts.
    - **Sublicensing options**: Distribute Sign Leuna as part of your product to your customers (terms vary by agreement).
  ...
  <Accordion title="License Setup">
    Enterprise feature enforcement has been removed while billing is being rebuilt. No license key is currently required for self-hosting.
...
<Accordions type="multiple">
  <Accordion title="Grant of License">
    The Enterprise license is a commercial agreement between your organisation and Sign Leuna. Key terms include:

    - **Scope**: License to use, modify, and distribute Sign Leuna as specified in your agreement
    - **Exclusions**: The license does not grant rights to Sign Leuna trademarks beyond what's specified
  ...
  <Accordion title="What the License Does Not Cover">
    ...
    - Sign Leuna Cloud service (separate subscription)
...
| Factor              | Description                         |
| ------------------- | ----------------------------------- |
| **Deployment type** | Self-hosted or Sign Leuna Cloud      |
...
<Steps>
  ...
  <Step>
    ...
    - Email: [sales@leuna.app](https://documen.so/enterprise)
  ...
  <Step>
    ...
    Options for evaluating Sign Leuna before purchase:
  ...
  <Step>
    ...
    3. Deploy using [self-hosting guides](/docs/self-hosting) or access Sign Leuna Cloud
...
<Accordions type="multiple">
  ...
  <Accordion title="Does the Enterprise license include Sign Leuna Cloud?">
