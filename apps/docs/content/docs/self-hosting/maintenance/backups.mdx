---
title: Backups
description: Backup strategies for Sign Leuna data.
---
...
Sign Leuna stores data in three locations:
...
Create a script to back up all Sign Leuna components:
...
echo "Starting Sign Leuna backup: $TIMESTAMP"
...
```ini
[Unit]
Description=Daily Sign Leuna Backup
