...
description: Diagnose and resolve common issues with your self-hosted Sign Leuna instance, organized by component.
---
...
Sign Leuna exposes a health endpoint to verify the application is running:
...
<Steps>
  ...
  <Step>
    Change Sign Leuna's port mapping: `-p 3001:3000`
  </Step>
</Steps>
...
```
  ...
  <Step>
    Update the certificate file and restart Sign Leuna
  </Step>
</Steps>
...
- **[Discord](https://documen.so/discord)**: Join the Sign Leuna community Discord
...
For security vulnerabilities, do not open a public issue. Contact security@leuna.app directly.
