...
description: Deploy Sign Leuna with Docker Compose, including PostgreSQL. This production-ready setup is suitable for most self-hosted deployments.
---
...
The Sign Leuna container waits for the database health check to pass before starting.
...
# Public URL where Sign Leuna is accessible
...
For production, place Sign Leuna behind a reverse proxy for SSL termination:
