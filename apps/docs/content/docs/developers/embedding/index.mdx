...
Sign Leuna offers two types of embedding:
...
- Dark mode controls
- Removal of Sign Leuna branding
...
<Steps>
<Step>
Navigate to your team's templates in Sign Leuna
...
For example, `https://app.leuna.app/d/-WoSwWVT-fYOERS2MI37k` has the token `-WoSwWVT-fYOERS2MI37k`.
...
| `host`                | `string`   | Sign Leuna instance URL. Defaults to `https://app.leuna.app`. |
