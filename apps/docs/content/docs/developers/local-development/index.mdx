...
description: Learn how to set up Sign Leuna for local development.
---

## Overview

There are multiple ways of setting up Sign Leuna for local development. At the moment of writing this documentation, there are 3 ways of running Sign Leuna locally:
...
<div className="mt-16 flex items-center justify-center gap-4">
  <a href="https://documen.so/discord">
    <img
      ...
      alt="Join Sign Leuna on Discord"
    />
  </a>
...
- [Contributing](/docs/developers/contributing) - Learn how to contribute to Sign Leuna
