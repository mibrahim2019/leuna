---
title: Manual Setup
description: Manually set up Sign Leuna on your machine for local development.
---
...
Follow these steps to set up Sign Leuna on your local machine:
...
Fork the [Sign Leuna repository](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks) to your GitHub account.
...
Access the Sign Leuna application by visiting `http://localhost:3000` in your web browser.
