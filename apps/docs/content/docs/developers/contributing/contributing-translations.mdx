...
description: Learn how to contribute translations to Sign Leuna and become part of our community.
---
...
msgid "Want to send slick signing links like this one? <0>Check out Sign Leuna.</0>"
msgstr "Möchten Sie auffällige Signatur-Links wie diesen senden? <0>Überprüfen Sie Sign Leuna.</0>"
```
...
Thank you for helping make Sign Leuna more accessible to users around the world!
