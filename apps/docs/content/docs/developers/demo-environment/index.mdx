...
description: Use the demo environment to try out the Sign Leuna platform and its features.
---
...
You can use it to try out the Sign Leuna platform and its features before committing to a paid plan.
...
<Steps>
  <Step>
    ...
    Go to the [staging environment](https://stg-app.leuna.app).
  ...
  <Step>
    ...
    If you have any issues, questions or feedback, please reach out to us on the [Sign Leuna Discord](https://documen.so/discord) or [GitHub](https://github.com/documenso/documenso/issues).
